...
- **Prepare an oral final report to be given on December 30. It can be either in Chinese or English. Each group has 20 minutes to introduce (1) how you selected your target sources and why, (2) problems in saw in the data calibration/imaging, and (3) your results. Each group will have only 1 representative to give the oral presentation. The representative will be randomly selected by me.**
